...
class FGVCAircraft(DatasetBase):
    ...
    def __init__(self, root, shot, seed, subsample="all"):
        ...
        train = self.read_data(cname2lab,"data/images_variant_train.txt")
        val = self.read_data(cname2lab, "data/images_variant_val.txt")
        test = self.read_data(cname2lab, "data/images_variant_test.txt")
