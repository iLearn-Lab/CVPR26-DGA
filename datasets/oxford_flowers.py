...
class OxfordFlowers(DatasetBase):
    ...
    def __init__(self, root, shot, seed, labels_list=None, model_name=None, subsample="all"):
        ...
        self.split_path = os.path.join(self.dataset_dir, f"split_OxfordFlowers_{n_layers}layers{model_suffix}.json")
        self.split_fewshot_dir = os.path.join(self.dataset_dir, f"split_fewshot{n_layers}layers{model_suffix}")
        mkdir_if_missing(self.split_fewshot_dir)

        # Read subclass names and indices
        self._lab2cname = read_json(self.lab2cname_file)
        classnames = [self._lab2cname[str(i + 1)] for i in range(len(self._lab2cname))]
    ...
    def read_data(self):
        ...
        def _collate(ims, y, c):
            ...
            for im in ims:
                ...
                subclass_idx = y - 1  # convert subclass index to 0-based
        ...
        for label, impaths in tracker.items():
            ...
            cname = self._lab2cname[str(label)]
